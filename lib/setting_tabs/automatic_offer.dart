        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              padding: const EdgeInsets.all(10.0),
              child:
                  Text('Offers to be Added', style: TextStyle(fontSize: 18.sp)),
            ),
            Card(
                elevation: 5,
                child: Container(
            ...
            Padding(
              padding: const EdgeInsets.all(10.0),
              child: Text('Favorite Place', style: TextStyle(fontSize: 15.sp)),
            ),
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: CustomTextFormSingleIcon(
            ...
            Padding(
              padding: const EdgeInsets.all(10.0),
              child: Text('Favorite sector', style: TextStyle(fontSize: 15.sp)),
            ),
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: CustomTextFormSingleIcon(
