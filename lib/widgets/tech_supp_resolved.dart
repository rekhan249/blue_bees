...
class TechSuppResolving extends StatefulWidget {
  const TechSuppResolving({super.key});

  @override
  State<TechSuppResolving> createState() => _TechSuppResolvingState();
}

class _TechSuppResolvingState extends State<TechSuppResolving> {
